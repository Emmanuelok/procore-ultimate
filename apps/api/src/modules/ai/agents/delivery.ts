...
export const riskMonitor = defineAgent({
  ...
  requiredTools: ["risk", "quality", "rfis", "forensics", "safety"],
...
export const costForecaster = defineAgent({
  ...
  requiredTools: ["budget", "commitments", "change_management"],
...
export const scheduleRiskAnalyst = defineAgent({
  ...
  requiredTools: ["schedule", "forensics", "rfis"],
...
export const changeImpactAnalyst = defineAgent({
  ...
  requiredTools: ["change_management", "budget", "commitments"],
